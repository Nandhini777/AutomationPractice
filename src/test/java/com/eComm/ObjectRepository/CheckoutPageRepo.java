...
public class CheckoutPageRepo extends DriverClass {
	
	public static CheckoutPageRepo CheckoutPageRepo=null;
...
//Create Singleton Class
	...
	public static CheckoutPageRepo getInstance()
	{
		if(CheckoutPageRepo==null)
		{
			CheckoutPageRepo=new CheckoutPageRepo(DriverClass.driver);
		}
		return CheckoutPageRepo;
