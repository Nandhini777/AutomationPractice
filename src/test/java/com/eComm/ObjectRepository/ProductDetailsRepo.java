...
public class ProductDetailsRepo extends DriverClass {
	
	public static ProductDetailsRepo ProductDetailsRepo=null;
	
//	Page intialize
	public ProductDetailsRepo(WebDriver driver)
	{
...
//Create Singleton Class
	...
	{
		if(ProductDetailsRepo==null)
		{
			ProductDetailsRepo=new ProductDetailsRepo(DriverClass.driver);
		}
