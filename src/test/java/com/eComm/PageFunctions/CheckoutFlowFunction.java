...
public class CheckoutFlowFunction extends CommonClasses {

	public static CheckoutFlowFunction CheckoutFlowFunction;

	public static CheckoutFlowFunction getInstance() {
		if (CheckoutFlowFunction == null) {
			CheckoutFlowFunction = new CheckoutFlowFunction();
		}
		return CheckoutFlowFunction;
