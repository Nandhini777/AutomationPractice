...
public class RegistrationPageFunction extends CommonClasses {

	public static RegistrationPageFunction RegistrationPageFunction;

	public static RegistrationPageFunction getInstance() {
		if (RegistrationPageFunction == null) {
			RegistrationPageFunction = new RegistrationPageFunction();
		}
		return RegistrationPageFunction;
